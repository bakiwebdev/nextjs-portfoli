  ...
  return (
    <section className="relative my-10 w-full h-fit px-2 md:px-16 py-16 md:py-20 flex flex-col justify-between gap-4">
      ...
      <section className="mx-auto w-full h-fit md:h-[20rem] lg:h-[30rem] my-10 grid md:grid-cols-3 gap-5 ">
        ...
        />
        <div className="absolute top-3 md:top-0 -left-2 md:-left-4 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 md:animate-blob"></div>
        <div className="absolute top-1/3 md:top-10 -right-4 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 md:animate-blob md:animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-20 md:left-1/2 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 md:animate-blob md:animation-delay-4000"></div>
      </section>
    </section>
  );
};
